...
namespace CocktailHub.Infrastructure.Migrations
{
    ...
    [Migration("20260402101312_AddExtendedDescription")]
    partial class AddExtendedDescription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CocktailHub.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$8OlL.PCF/I3wsRQ0RCK/4.ORKAfGzQAtN1B5pO/3LuBfaIBOeyNHC",
                            Role = 1
                        });
                });
